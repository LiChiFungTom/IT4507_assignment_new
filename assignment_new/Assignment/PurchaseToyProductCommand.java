...
public class PurchaseToyProductCommand implements Commend{
    ...
    public void execute(){
        ...
        if(code == 1001){
            ...
            Enumeration enu = product.elements();
            RemoteControlCar rc = (RemoteControlCar)enu.nextElement();
            rc.setQty(qty);
            rc.setCost(cost);
            System.out.println("Purchased"+rc.getQty()+" Box of "+rc.getName()+".Current quantity is $"+rc.getCost()+".Price is $"+rc.getPrice());
